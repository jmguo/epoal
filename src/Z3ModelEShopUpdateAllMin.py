...
#Sums for Attributes
s.add(total_Cost== 7.6*If(eShop, 1.0, 0.0 ) \
+ 7.5*If(store_front, 1.0, 0.0 ) \
+ 14.7*If(homepage, 1.0, 0.0 ) \
+ 6.2*If(_id_1, 1.0, 0.0 ) \
+ 10.4*If(_id_2, 1.0, 0.0 ) \
+ 9.8*If(_id_3, 1.0, 0.0 ) \
+ 8.1*If(_id_5, 1.0, 0.0 ) \
+ 13.5*If(special_offers, 1.0, 0.0 ) \
+ 11.0*If(_id_6, 1.0, 0.0 ) \
+ 8.9*If(_id_8, 1.0, 0.0 ) \
+ 7.7*If(_id_9, 1.0, 0.0 ) \
+ 6.5*If(registration, 1.0, 0.0 ) \
+ 11.4*If(registration_enforcement, 1.0, 0.0 ) \
+ 7.4*If(_id_11, 1.0, 0.0 ) \
+ 13.4*If(register_to_buy, 1.0, 0.0 ) \
+ 5.5*If(_id_12, 1.0, 0.0 ) \
+ 6.1*If(_id_13, 1.0, 0.0 ) \
+ 12.3*If(_id_14, 1.0, 0.0 ) \
+ 5.7*If(shipping_address, 1.0, 0.0 ) \
+ 10.3*If(_id_15, 1.0, 0.0 ) \
+ 5.9*If(_id_16, 1.0, 0.0 ) \
+ 11.5*If(_id_17, 1.0, 0.0 ) \
+ 13.7*If(_id_18, 1.0, 0.0 ) \
+ 13.0*If(_id_19, 1.0, 0.0 ) \
+ 10.0*If(_id_20, 1.0, 0.0 ) \
+ 9.7*If(_id_21, 1.0, 0.0 ) \
+ 11.1*If(_id_22, 1.0, 0.0 ) \
+ 12.2*If(_id_23, 1.0, 0.0 ) \
+ 8.6*If(_id_25, 1.0, 0.0 ) \
+ 10.6*If(_id_26, 1.0, 0.0 ) \
+ 13.0*If(_id_27, 1.0, 0.0 ) \
+ 12.1*If(_id_28, 1.0, 0.0 ) \
+ 10.5*If(_id_29, 1.0, 0.0 ) \
+ 14.1*If(preferences, 1.0, 0.0 ) \
+ 6.7*If(_id_31, 1.0, 0.0 ) \
+ 5.0*If(_id_32, 1.0, 0.0 ) \
+ 9.6*If(_id_33, 1.0, 0.0 ) \
+ 5.2*If(_id_34, 1.0, 0.0 ) \
+ 12.2*If(quick_checkout_profile, 1.0, 0.0 ) \
+ 13.7*If(_id_35, 1.0, 0 ) \
+ 11.7*If(user_behaviour_tracking_info, 1.0, 0 ) \
+ 9.1*If(catalog, 1.0, 0 ) \
+ 8.3*If(product_information, 1.0, 0 ) \
+ 13.8*If(product_type, 1.0, 0 ) \
+ 13.4*If(eletronic_goods, 1.0, 0 ) \
+ 6.7*If(physical_goods, 1.0, 0 ) \
+ 12.7*If(services, 1.0, 0 ) \
+ 11.5*If(basic_information, 1.0, 0 ) \
+ 12.5*If(detailed_information, 1.0, 0 ) \
+ 14.2*If(warranty_information, 1.0, 0 ) \
+ 13.1*If(customer_reviews, 1.0, 0 ) \
+ 11.7*If(associated_assets, 1.0, 0 ) \
+ 11.5*If(_id_38, 1.0, 0 ) \
+ 9.5*If(_id_39, 1.0, 0 ) \
+ 10.2*If(_id_41, 1.0, 0 ) \
+ 14.8*If(_id_43, 1.0, 0 ) \
+ 10.1*If(_id_44, 1.0, 0 ) \
+ 10.2*If(_id_45, 1.0, 0 ) \
+ 7.5*If(_id_46, 1.0, 0 ) \
+ 12.0*If(_id_47, 1.0, 0 ) \
+ 5.5*If(_id_48, 1.0, 0 ) \
+ 11.2*If(_id_49, 1.0, 0 ) \
+ 12.5*If(_id_50, 1.0, 0 ) \
+ 6.5*If(product_variants, 1.0, 0 ) \
+ 14.0*If(_id_51, 1.0, 0 ) \
+ 7.4*If(size, 1.0, 0 ) \
+ 13.5*If(weight, 1.0, 0 ) \
+ 10.5*If(availability, 1.0, 0 ) \
+ 11.7*If(custom_fields, 1.0, 0 ) \
+ 7.0*If(categories, 1.0, 0 ) \
+ 8.4*If(categories_catalog, 1.0, 0 ) \
+ 10.6*If(_id_52, 1.0, 0 ) \
+ 11.1*If(_id_53, 1.0, 0 ) \
+ 13.9*If(_id_54, 1.0, 0 ) \
+ 9.6*If(_id_55, 1.0, 0 ) \
+ 12.4*If(_id_56, 1.0, 0 ) \
+ 9.5*If(_id_58, 1.0, 0 ) \
+ 13.7*If(_id_59, 1.0, 0 ) \
+ 5.5*If(_id_60, 1.0, 0 ) \
+ 6.5*If(_id_61, 1.0, 0 ) \
+ 12.5*If(category_page, 1.0, 0 ) \
+ 8.0*If(_id_62, 1.0, 0 ) \
+ 7.0*If(_id_63, 1.0, 0 ) \
+ 11.5*If(_id_65, 1.0, 0 ) \
+ 10.1*If(_id_66, 1.0, 0 ) \
+ 10.9*If(_id_67, 1.0, 0 ) \
+ 14.7*If(_id_68, 1.0, 0 ) \
+ 12.9*If(_id_69, 1.0, 0 ) \
+ 13.0*If(_id_70, 1.0, 0 ) \
+ 11.5*If(_id_71, 1.0, 0 ) \
+ 11.0*If(_id_72, 1.0, 0 ) \
+ 5.6*If(wish_list, 1.0, 0 ) \
+ 7.4*If(wish_list_saved_after_session, 1.0, 0 ) \
+ 11.6*If(email_wish_list, 1.0, 0 ) \
+ 14.1*If(_id_73, 1.0, 0 ) \
+ 8.3*If(permissions, 1.0, 0 ) \
+ 12.5*If(_id_75, 1.0, 0 ) \
+ 8.6*If(_id_76, 1.0, 0 ) \
+ 12.6*If(_id_77, 1.0, 0 ) \
+ 10.2*If(buy_paths, 1.0, 0 ) \
+ 6.5*If(_id_78, 1.0, 0 ) \
+ 8.2*If(_id_79, 1.0, 0 ) \
+ 5.7*If(_id_80, 1.0, 0 ) \
+ 6.9*If(_id_81, 1.0, 0 ) \
+ 12.6*If(_id_82, 1.0, 0 ) \
+ 6.2*If(_id_83, 1.0, 0 ) \
+ 11.7*If(_id_84, 1.0, 0 ) \
+ 5.3*If(registered_checkout, 1.0, 0 ) \
+ 11.0*If(quick_checkout, 1.0, 0 ) \
+ 11.5*If(_id_86, 1.0, 0 ) \
+ 10.4*If(_id_87, 1.0, 0 ) \
+ 14.5*If(shipping_options, 1.0, 0 ) \
+ 7.1*If(_id_88, 1.0, 0 ) \
+ 6.4*If(_id_89, 1.0, 0 ) \
+ 13.2*If(_id_90, 1.0, 0 ) \
+ 9.0*If(_id_91, 1.0, 0 ) \
+ 9.7*If(_id_92, 1.0, 0 ) \
+ 13.7*If(_id_93, 1.0, 0 ) \
+ 8.1*If(_id_95, 1.0, 0 ) \
+ 5.8*If(_id_96, 1.0, 0 ) \
+ 9.5*If(_id_98, 1.0, 0 ) \
+ 5.5*If(_id_99, 1.0, 0 ) \
+ 11.1*If(_id_100, 1.0, 0 ) \
+ 9.9*If(_id_101, 1.0, 0 ) \
+ 6.1*If(shipping_2, 1.0, 0 ) \
+ 6.5*If(_id_102, 1.0, 0 ) \
+ 11.2*If(_id_103, 1.0, 0 ) \
+ 14.2*If(_id_105, 1.0, 0 ) \
+ 7.6*If(_id_106, 1.0, 0 ) \
+ 14.8*If(_id_107, 1.0, 0 ) \
+ 5.9*If(_id_108, 1.0, 0 ) \
+ 14.1*If(_id_110, 1.0, 0 ) \
+ 13.3*If(_id_111, 1.0, 0 ) \
+ 6.5*If(_id_112, 1.0, 0 ) \
+ 10.1*If(_id_114, 1.0, 0 ) \
+ 7.6*If(_id_115, 1.0, 0 ) \
+ 11.3*If(_id_116, 1.0, 0 ) \
+ 12.8*If(_id_117, 1.0, 0 ) \
+ 11.2*If(_id_118, 1.0, 0 ) \
+ 10.4*If(_id_120, 1.0, 0 ) \
+ 10.2*If(_id_121, 1.0, 0 ) \
+ 9.1*If(_id_122, 1.0, 0 ) \
+ 10.9*If(_id_123, 1.0, 0 ) \
+ 10.1*If(_id_124, 1.0, 0 ) \
+ 14.3*If(_id_125, 1.0, 0 ) \
+ 12.7*If(_id_126, 1.0, 0 ) \
+ 9.4*If(_id_127, 1.0, 0 ) \
+ 10.2*If(_id_128, 1.0, 0 ) \
+ 12.3*If(_id_129, 1.0, 0 ) \
+ 13.5*If(_id_130, 1.0, 0 ) \
+ 9.8*If(_id_132, 1.0, 0 ) \
+ 13.4*If(_id_133, 1.0, 0 ) \
+ 6.3*If(_id_134, 1.0, 0 ) \
+ 14.3*If(_id_135, 1.0, 0 ) \
+ 13.5*If(_id_136, 1.0, 0 ) \
+ 11.6*If(_id_137, 1.0, 0 ) \
+ 10.7*If(_id_138, 1.0, 0 ) \
+ 7.8*If(_id_139, 1.0, 0 ) \
+ 10.5*If(_id_141, 1.0, 0 ) \
+ 14.5*If(_id_142, 1.0, 0 ) \
+ 8.3*If(_id_143, 1.0, 0 ) \
+ 14.5*If(_id_144, 1.0, 0 ) \
+ 5.9*If(buy_paths_288_289, 1.0, 0 ) \
+ 7.3*If(buy_paths_288_289_290, 1.0, 0 ) \
+ 7.3*If(buy_paths_288_289_291, 1.0, 0 ) \
+ 9.8*If(customer_service, 1.0, 0 ) \
+ 13.7*If(_id_146, 1.0, 0 ) \
+ 9.2*If(_id_147, 1.0, 0 ) \
+ 11.4*If(_id_148, 1.0, 0 ) \
+ 6.2*If(_id_149, 1.0, 0 ) \
+ 5.5*If(_id_150, 1.0, 0 ) \
+ 14.5*If(_id_152, 1.0, 0 ) \
+ 9.0*If(_id_153, 1.0, 0 ) \
+ 9.6*If(_id_154, 1.0, 0 ) \
+ 9.6*If(_id_155, 1.0, 0 ) \
+ 9.6*If(_id_156, 1.0, 0 ) \
+ 6.2*If(_id_158, 1.0, 0 ) \
+ 6.4*If(_id_159, 1.0, 0 ) \
+ 9.0*If(user_behaviour_tracking, 1.0, 0 ) \
+ 10.2*If(_id_160, 1.0, 0 ) \
+ 13.7*If(locally_visited_pages, 1.0, 0 ) \
+ 8.8*If(external_referring_pages, 1.0, 0 ) \
+ 14.8*If(behaviour_tracked_previous_purchases, 1.0, 0 ) \
+ 5.2*If(business_management, 1.0, 0 ) \
+ 10.7*If(_id_162, 1.0, 0 ) \
+ 8.3*If(_id_163, 1.0, 0 ) \
+ 7.4*If(physical_goods_fulfillment, 1.0, 0 ) \
+ 5.2*If(warehouse_management, 1.0, 0 ) \
+ 13.9*If(shipping, 1.0, 0 ) \
+ 14.3*If(_id_166, 1.0, 0 ) \
+ 5.2*If(_id_167, 1.0, 0 ) \
+ 10.7*If(_id_168, 1.0, 0 ) \
+ 14.9*If(_id_169, 1.0, 0 ) \
+ 14.6*If(_id_171, 1.0, 0 ) \
+ 12.3*If(_id_172, 1.0, 0 ) \
+ 7.7*If(_id_173, 1.0, 0 ) \
+ 8.0*If(_id_174, 1.0, 0 ) \
+ 7.5*If(_id_175, 1.0, 0 ) \
+ 14.1*If(_id_177, 1.0, 0 ) \
+ 13.2*If(_id_178, 1.0, 0 ) \
+ 7.4*If(_id_179, 1.0, 0 ) \
+ 7.7*If(_id_180, 1.0, 0 ) \
+ 6.4*If(_id_181, 1.0, 0 ) \
+ 12.1*If(eletronic_goods_fulfillment, 1.0, 0 ) \
+ 12.9*If(_id_182, 1.0, 0 ) \
+ 7.8*If(_id_183, 1.0, 0 ) \
+ 7.8*If(services_fulfillment, 1.0, 0 ) \
+ 12.5*If(_id_184, 1.0, 0 ) \
+ 5.3*If(_id_185, 1.0, 0 ) \
+ 14.6*If(_id_186, 1.0, 0 ) \
+ 6.4*If(_id_187, 1.0, 0 ) \
+ 9.2*If(customer_preferences, 1.0, 0 ) \
+ 12.8*If(_id_189, 1.0, 0 ) \
+ 8.7*If(_id_190, 1.0, 0 ) \
+ 6.9*If(targeting_criteria_previous_purchases, 1.0, 0 ) \
+ 9.1*If(_id_191, 1.0, 0 ) \
+ 11.2*If(wish_list_content, 1.0, 0 ) \
+ 7.3*If(previously_visited_pages, 1.0, 0 ) \
+ 5.8*If(_id_192, 1.0, 0 ) \
+ 9.1*If(_id_193, 1.0, 0 ) \
+ 11.1*If(_id_194, 1.0, 0 ) \
+ 12.5*If(_id_196, 1.0, 0 ) \
+ 13.4*If(_id_197, 1.0, 0 ) \
+ 6.6*If(_id_199, 1.0, 0 ) \
+ 13.3*If(_id_200, 1.0, 0 ) \
+ 5.9*If(_id_201, 1.0, 0 ) \
+ 5.5*If(_id_203, 1.0, 0 ) \
+ 10.4*If(_id_204, 1.0, 0 ) \
+ 10.6*If(_id_205, 1.0, 0 ) \
+ 5.4*If(_id_206, 1.0, 0 ) \
+ 14.3*If(_id_207, 1.0, 0 ) \
+ 7.8*If(discounts, 1.0, 0 ) \
+ 6.9*If(_id_208, 1.0, 0 ) \
+ 7.1*If(_id_209, 1.0, 0 ) \
+ 12.6*If(_id_210, 1.0, 0 ) \
+ 7.6*If(_id_211, 1.0, 0 ) \
+ 9.7*If(_id_212, 1.0, 0 ) \
+ 5.8*If(_id_214, 1.0, 0 ) \
+ 14.0*If(_id_215, 1.0, 0 ) \
+ 13.3*If(_id_216, 1.0, 0 ) \
+ 5.6*If(_id_217, 1.0, 0 ) \
+ 11.7*If(_id_218, 1.0, 0 ) \
+ 13.6*If(_id_219, 1.0, 0 ) \
+ 7.6*If(_id_220, 1.0, 0 ) \
+ 5.7*If(_id_222, 1.0, 0 ) \
+ 7.8*If(_id_223, 1.0, 0 ) \
+ 8.9*If(_id_224, 1.0, 0 ) \
+ 12.1*If(_id_225, 1.0, 0 ) \
+ 10.8*If(_id_226, 1.0, 0 ) \
+ 10.8*If(_id_228, 1.0, 0 ) \
+ 8.4*If(_id_229, 1.0, 0 ) \
+ 14.5*If(_id_230, 1.0, 0 ) \
+ 8.7*If(_id_231, 1.0, 0 ) \
+ 8.8*If(_id_232, 1.0, 0 ) \
+ 11.9*If(_id_233, 1.0, 0 ) \
+ 12.0*If(_id_235, 1.0, 0 ) \
+ 11.2*If(_id_236, 1.0, 0 ) \
+ 10.0*If(_id_237, 1.0, 0 ) \
+ 9.2*If(personalized_emails, 1.0, 0 ) \
+ 13.9*If(_id_238, 1.0, 0 ) \
+ 9.2*If(_id_239, 1.0, 0 ) \
+ 8.0*If(_id_240, 1.0, 0 ) \
+ 10.8*If(_id_241, 1.0, 0 ) \
+ 11.7*If(_id_242, 1.0, 0 ) \
+ 7.6*If(inventory_tracking, 1.0, 0 ) \
+ 8.3*If(_id_243, 1.0, 0 ) \
+ 8.6*If(procurement, 1.0, 0 ) \
+ 10.7*If(_id_244, 1.0, 0 ) \
+ 12.2*If(_id_245, 1.0, 0 ) \
+ 6.2*If(automatic, 1.0, 0 ) \
+ 5.8*If(_id_246, 1.0, 0 ) \
+ 8.9*If(reporting_and_analysis, 1.0, 0 ) \
+ 8.4*If(_id_247, 1.0, 0 ) \
+ 8.1*If(_id_248, 1.0, 0 ) \
+ 13.9*If(_id_249, 1.0, 0 ) \
+ 6.1*If(_id_250, 1.0, 0 ) \
+ 7.1*If(fulfillment_system, 1.0, 0 ) \
+ 7.3*If(_id_252, 1.0, 0 ) \
+ 10.1*If(procurement_system, 1.0, 0 ) \
+ 5.0*If(_id_253, 1.0, 0 ) \
+ 8.8*If(_id_254, 1.0, 0 ) \
+ 12.2*If(_id_255, 1.0, 0 ) \
+ 10.8*If(_id_256, 1.0, 0 ) \
+ 12.7*If(_id_257, 1.0, 0 ) \
+ 5.9*If(_id_258, 1.0, 0 ) \
+ 7.5*If(_id_259, 1.0, 0 ) \
+ 12.7*If(_id_260, 1.0, 0 ) \
+ 5.1*If(_id_261, 1.0, 0 ) \
+ 13.4*If(_id_262, 1.0, 0 ) \
+ 12.0*If(_id_263, 1.0, 0 ) \
)
s.add(total_UsedBefore== 1*If(eShop, 0, 1 ) \
+ 0*If(store_front, 0, 1 ) \
+ 1*If(homepage, 0, 1 ) \
+ 0*If(_id_1, 0, 1 ) \
+ 0*If(_id_2, 0, 1 ) \
+ 1*If(_id_3, 0, 1 ) \
+ 0*If(_id_5, 0, 1 ) \
+ 1*If(special_offers, 0, 1 ) \
+ 1*If(_id_6, 0, 1 ) \
+ 0*If(_id_8, 0, 1 ) \
+ 1*If(_id_9, 0, 1 ) \
+ 1*If(registration, 0, 1 ) \
+ 0*If(registration_enforcement, 0, 1 ) \
+ 1*If(_id_11, 0, 1 ) \
+ 0*If(register_to_buy, 0, 1 ) \
+ 1*If(_id_12, 0, 1 ) \
+ 0*If(_id_13, 0, 1 ) \
+ 1*If(_id_14, 0, 1 ) \
+ 0*If(shipping_address, 0, 1 ) \
+ 0*If(_id_15, 0, 1 ) \
+ 0*If(_id_16, 0, 1 ) \
+ 0*If(_id_17, 0, 1 ) \
+ 1*If(_id_18, 0, 1 ) \
...
+ 1*If(_id_28, 0, 1 ) \
+ 0*If(_id_29, 0, 1 ) \
+ 1*If(preferences, 0, 1 ) \
+ 0*If(_id_31, 0, 1 ) \
+ 0*If(_id_32, 0, 1 ) \
+ 0*If(_id_33, 0, 1 ) \
+ 1*If(_id_34, 0, 1 ) \
+ 0*If(quick_checkout_profile, 0, 1 ) \
+ 0*If(_id_35, 0, 1 ) \
+ 0*If(user_behaviour_tracking_info, 0, 1 ) \
+ 0*If(catalog, 0, 1 ) \
+ 0*If(product_information, 0, 1 ) \
+ 0*If(product_type, 0, 1 ) \
+ 0*If(eletronic_goods, 0, 1 ) \
+ 1*If(physical_goods, 0, 1 ) \
+ 1*If(services, 0, 1 ) \
+ 0*If(basic_information, 0, 1 ) \
+ 0*If(detailed_information, 0, 1 ) \
+ 0*If(warranty_information, 0, 1 ) \
+ 1*If(customer_reviews, 0, 1 ) \
+ 1*If(associated_assets, 0, 1 ) \
+ 0*If(_id_38, 0, 1 ) \
+ 1*If(_id_39, 0, 1 ) \
+ 0*If(_id_41, 0, 1 ) \
+ 0*If(_id_43, 0, 1 ) \
...
+ 1*If(_id_49, 0, 1 ) \
+ 0*If(_id_50, 0, 1 ) \
+ 0*If(product_variants, 0, 1 ) \
+ 0*If(_id_51, 0, 1 ) \
+ 0*If(size, 0, 1 ) \
+ 1*If(weight, 0, 1 ) \
+ 0*If(availability, 0, 1 ) \
+ 1*If(custom_fields, 0, 1 ) \
+ 1*If(categories, 0, 1 ) \
+ 1*If(categories_catalog, 0, 1 ) \
+ 0*If(_id_52, 0, 1 ) \
+ 1*If(_id_53, 0, 1 ) \
+ 0*If(_id_54, 0, 1 ) \
+ 1*If(_id_55, 0, 1 ) \
...
+ 0*If(_id_72, 0, 1 ) \
+ 0*If(wish_list, 0, 1 ) \
+ 0*If(wish_list_saved_after_session, 0, 1 ) \
+ 1*If(email_wish_list, 0, 1 ) \
+ 0*If(_id_73, 0, 1 ) \
+ 0*If(permissions, 0, 1 ) \
+ 1*If(_id_75, 0, 1 ) \
+ 0*If(_id_76, 0, 1 ) \
+ 0*If(_id_77, 0, 1 ) \
+ 1*If(buy_paths, 0, 1 ) \
...
+ 1*If(_id_83, 0, 1 ) \
+ 0*If(_id_84, 0, 1 ) \
+ 1*If(registered_checkout, 0, 1 ) \
+ 1*If(quick_checkout, 0, 1 ) \
+ 0*If(_id_86, 0, 1 ) \
+ 1*If(_id_87, 0, 1 ) \
+ 1*If(shipping_options, 0, 1 ) \
+ 1*If(_id_88, 0, 1 ) \
+ 1*If(_id_89, 0, 1 ) \
+ 0*If(_id_90, 0, 1 ) \
+ 0*If(_id_91, 0, 1 ) \
...
+ 0*If(_id_143, 0, 1 ) \
+ 0*If(_id_144, 0, 1 ) \
+ 0*If(buy_paths_288_289, 0, 1 ) \
+ 0*If(buy_paths_288_289_290, 0, 1 ) \
+ 1*If(buy_paths_288_289_291, 0, 1 ) \
+ 1*If(customer_service, 0, 1 ) \
+ 1*If(_id_146, 0, 1 ) \
+ 0*If(_id_147, 0, 1 ) \
+ 1*If(_id_148, 0, 1 ) \
+ 0*If(_id_149, 0, 1 ) \
...
+ 0*If(_id_158, 0, 1 ) \
+ 1*If(_id_159, 0, 1 ) \
+ 1*If(user_behaviour_tracking, 0, 1 ) \
+ 0*If(_id_160, 0, 1 ) \
+ 1*If(locally_visited_pages, 0, 1 ) \
+ 0*If(external_referring_pages, 0, 1 ) \
+ 1*If(behaviour_tracked_previous_purchases, 0, 1 ) \
+ 0*If(business_management, 0, 1 ) \
+ 1*If(_id_162, 0, 1 ) \
+ 1*If(_id_163, 0, 1 ) \
+ 1*If(physical_goods_fulfillment, 0, 1 ) \
+ 0*If(warehouse_management, 0, 1 ) \
+ 1*If(shipping, 0, 1 ) \
+ 0*If(_id_166, 0, 1 ) \
+ 0*If(_id_167, 0, 1 ) \
+ 0*If(_id_168, 0, 1 ) \
...
+ 1*If(_id_180, 0, 1 ) \
+ 0*If(_id_181, 0, 1 ) \
+ 0*If(eletronic_goods_fulfillment, 0, 1 ) \
+ 1*If(_id_182, 0, 1 ) \
+ 0*If(_id_183, 0, 1 ) \
+ 0*If(services_fulfillment, 0, 1 ) \
+ 0*If(_id_184, 0, 1 ) \
+ 0*If(_id_185, 0, 1 ) \
+ 1*If(_id_186, 0, 1 ) \
+ 1*If(_id_187, 0, 1 ) \
+ 1*If(customer_preferences, 0, 1 ) \
+ 1*If(_id_189, 0, 1 ) \
+ 0*If(_id_190, 0, 1 ) \
+ 0*If(targeting_criteria_previous_purchases, 0, 1 ) \
+ 1*If(_id_191, 0, 1 ) \
+ 1*If(wish_list_content, 0, 1 ) \
+ 1*If(previously_visited_pages, 0, 1 ) \
+ 0*If(_id_192, 0, 1 ) \
+ 1*If(_id_193, 0, 1 ) \
+ 0*If(_id_194, 0, 1 ) \
+ 1*If(_id_196, 0, 1 ) \
...
+ 0*If(_id_236, 0, 1 ) \
+ 0*If(_id_237, 0, 1 ) \
+ 1*If(personalized_emails, 0, 1 ) \
+ 0*If(_id_238, 0, 1 ) \
+ 1*If(_id_239, 0, 1 ) \
+ 0*If(_id_240, 0, 1 ) \
+ 1*If(_id_241, 0, 1 ) \
+ 0*If(_id_242, 0, 1 ) \
+ 1*If(inventory_tracking, 0, 1 ) \
+ 1*If(_id_243, 0, 1 ) \
+ 1*If(procurement, 0, 1 ) \
+ 1*If(_id_244, 0, 1 ) \
+ 0*If(_id_245, 0, 1 ) \
+ 1*If(automatic, 0, 1 ) \
+ 1*If(_id_246, 0, 1 ) \
+ 1*If(reporting_and_analysis, 0, 1 ) \
+ 0*If(_id_247, 0, 1 ) \
+ 0*If(_id_248, 0, 1 ) \
+ 1*If(_id_249, 0, 1 ) \
+ 0*If(_id_250, 0, 1 ) \
+ 1*If(fulfillment_system, 0, 1 ) \
+ 0*If(_id_252, 0, 1 ) \
+ 1*If(procurement_system, 0, 1 ) \
+ 1*If(_id_253, 0, 1 ) \
+ 0*If(_id_254, 0, 1 ) \
+ 0*If(_id_255, 0, 1 ) \
+ 0*If(_id_256, 0, 1 ) \
...
s.add(total_FeatureCount== 1*If(eShop, 0, 1 ) \
+ 1*If(store_front, 0, 1 ) \
+ 1*If(homepage, 0, 1 ) \
+ 1*If(_id_1, 0, 1 ) \
+ 1*If(_id_2, 0, 1 ) \
+ 1*If(_id_3, 0, 1 ) \
...
+ 1*If(_id_9, 0, 1 ) \
+ 1*If(registration, 0, 1 ) \
+ 1*If(registration_enforcement, 0, 1 ) \
+ 1*If(_id_11, 0, 1 ) \
+ 1*If(register_to_buy, 0, 1 ) \
+ 1*If(_id_12, 0, 1 ) \
+ 1*If(_id_13, 0, 1 ) \
+ 1*If(_id_14, 0, 1 ) \
+ 1*If(shipping_address, 0, 1 ) \
+ 1*If(_id_15, 0, 1 ) \
+ 1*If(_id_16, 0, 1 ) \
+ 1*If(_id_17, 0, 1 ) \
+ 1*If(_id_18, 0, 1 ) \
...
+ 1*If(_id_33, 0, 1 ) \
+ 1*If(_id_34, 0, 1 ) \
+ 1*If(quick_checkout_profile, 0, 1 ) \
+ 1*If(_id_35, 0, 1 ) \
+ 1*If(user_behaviour_tracking_info, 0, 1 ) \
+ 1*If(catalog, 0, 1 ) \
+ 1*If(product_information, 0, 1 ) \
+ 1*If(product_type, 0, 1 ) \
+ 1*If(eletronic_goods, 0, 1 ) \
+ 1*If(physical_goods, 0, 1 ) \
+ 1*If(services, 0, 1 ) \
+ 1*If(basic_information, 0, 1 ) \
+ 1*If(detailed_information, 0, 1 ) \
+ 1*If(warranty_information, 0, 1 ) \
+ 1*If(customer_reviews, 0, 1 ) \
+ 1*If(associated_assets, 0, 1 ) \
+ 1*If(_id_38, 0, 1 ) \
+ 1*If(_id_39, 0, 1 ) \
...
+ 1*If(_id_49, 0, 1 ) \
+ 1*If(_id_50, 0, 1 ) \
+ 1*If(product_variants, 0, 1 ) \
+ 1*If(_id_51, 0, 1 ) \
+ 1*If(size, 0, 1 ) \
+ 1*If(weight, 0, 1 ) \
+ 1*If(availability, 0, 1 ) \
+ 1*If(custom_fields, 0, 1 ) \
+ 1*If(categories, 0, 1 ) \
+ 1*If(categories_catalog, 0, 1 ) \
+ 1*If(_id_52, 0, 1 ) \
...
+ 1*If(_id_72, 0, 1 ) \
+ 1*If(wish_list, 0, 1 ) \
+ 1*If(wish_list_saved_after_session, 0, 1 ) \
+ 1*If(email_wish_list, 0, 1 ) \
+ 1*If(_id_73, 0, 1 ) \
+ 1*If(permissions, 0, 1 ) \
+ 1*If(_id_75, 0, 1 ) \
+ 1*If(_id_76, 0, 1 ) \
+ 1*If(_id_77, 0, 1 ) \
+ 1*If(buy_paths, 0, 1 ) \
...
+ 1*If(_id_143, 0, 1 ) \
+ 1*If(_id_144, 0, 1 ) \
+ 1*If(buy_paths_288_289, 0, 1 ) \
+ 1*If(buy_paths_288_289_290, 0, 1 ) \
+ 1*If(buy_paths_288_289_291, 0, 1 ) \
+ 1*If(customer_service, 0, 1 ) \
+ 1*If(_id_146, 0, 1 ) \
+ 1*If(_id_147, 0, 1 ) \
...
+ 1*If(_id_160, 0, 1 ) \
+ 1*If(locally_visited_pages, 0, 1 ) \
+ 1*If(external_referring_pages, 0, 1 ) \
+ 1*If(behaviour_tracked_previous_purchases, 0, 1 ) \
+ 1*If(business_management, 0, 1 ) \
+ 1*If(_id_162, 0, 1 ) \
+ 1*If(_id_163, 0, 1 ) \
+ 1*If(physical_goods_fulfillment, 0, 1 ) \
+ 1*If(warehouse_management, 0, 1 ) \
+ 1*If(shipping, 0, 1 ) \
+ 1*If(_id_166, 0, 1 ) \
+ 1*If(_id_167, 0, 1 ) \
+ 1*If(_id_168, 0, 1 ) \
...
+ 1*If(_id_180, 0, 1 ) \
+ 1*If(_id_181, 0, 1 ) \
+ 1*If(eletronic_goods_fulfillment, 0, 1 ) \
+ 1*If(_id_182, 0, 1 ) \
+ 1*If(_id_183, 0, 1 ) \
+ 1*If(services_fulfillment, 0, 1 ) \
+ 1*If(_id_184, 0, 1 ) \
+ 1*If(_id_185, 0, 1 ) \
+ 1*If(_id_186, 0, 1 ) \
+ 1*If(_id_187, 0, 1 ) \
...
+ 1*If(_id_189, 0, 1 ) \
+ 1*If(_id_190, 0, 1 ) \
+ 1*If(targeting_criteria_previous_purchases, 0, 1 ) \
+ 1*If(_id_191, 0, 1 ) \
+ 1*If(wish_list_content, 0, 1 ) \
+ 1*If(previously_visited_pages, 0, 1 ) \
+ 1*If(_id_192, 0, 1 ) \
...
metrics_objective_direction = [METRICS_MINIMIZE, METRICS_MINIMIZE, \
        METRICS_MINIMIZE, METRICS_MINIMIZE]
