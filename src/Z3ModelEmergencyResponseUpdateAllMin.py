...
s.add(total_reliability== If(gps, 1.33, 1.0 ) \
* If(radiotriangulation, 1.09, 1.0) \
* If(filemanageropentintents, 1.05, 1.0) \
* If(inhousefilemanager, 1.09, 1.0) \
* If(explicitreportssync, 1.14, 1.0) \
* If(implicitreportssync, 1.03, 1.0) \
* If(openfire, 1.05, 1.0) \
* If(inhousechatprotocol, 1.04, 1.0) \
* If(ondemandgooglesite, 1.1, 1.0) \
* If(cachedgoogleserver, 1.03, 1.0) \
* If(preloadedesri, 1.11, 1.0) \
* If(wifi, 1.18, 1.0) \
* If(threegnexusone, 1.14, 1.0) \
* If(threedroid, 1.14, 1.0) \
* If(bluetooth, 1.18, 1.0) \
* If(mysql, 1.11, 1.0) \
* If(sqlite, 1.11, 1.0) \
* If(peertopeer, 1.52, 1.0) \
* If(clientserver, 1.05, 1.0) \
* If(pushbased, 1.06, 1.0) 
)
